    ...
    for(int teta = 1; teta < 45; teta++) {
        ...
        for (int ro = 1; ro < ro_max; ro++) {
            ...
            for(int y = ymin; y < ymax; y++) {
                ...
                {
                sinogram->data[(ro_max - ro - 1) * najveci_teta + najveci_teta - teta - 1].blue += img->data[(y+centar_x)*img->x + (int)x + centar_y].blue/12;
                }
                ...
                {
                sinogram->data[(ro_max - ro - 1) * najveci_teta + najveci_teta - teta - 1].green += img->data[(y+centar_x)*img->x + (int)x + centar_y].green/12;
                }
                if(sinogram->data[(ro_max - ro - 1) * najveci_teta + najveci_teta - teta - 1].red + img->data[((int)y+centar_x)*img->x + (int)x + centar_y ].red <= 255)
                {
                sinogram->data[(ro_max - ro - 1) * najveci_teta + najveci_teta - teta - 1].red += img->data[(y+centar_x)*img->x + (int)x + centar_y].red/12;
                }
            }
        }
    }
